...
PK_SEND_HOOK_ADDRESS = 0x30098
GEN_PRIV_KEY_ADDRESS = 0x48eba
HOOKS_LOCATION = 0xd7800  # same used for monitor lmp start
ASM_HOOKS = """
b pk_recv_hook
b pk_send_hook
b gen_priv_key

// zero the y-coordinate of received PK point
pk_recv_hook:
    push {r0-r3,lr}
    strb.w  r0, [r4, 170]
    ldr r0, =0x205614
...
// zero y-coordinate of own PK point before sending it out
pk_send_hook:
    add r2, r0, 24
    mov r3, 0
    mov r1, 6
